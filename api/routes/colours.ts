...
routerColours.post('/colours', coloursController.create);

routerColours.get('/colours/:colourId', validateColourId, coloursController.show);

routerColours.put('/colours/:colourId', validateColourId, coloursController.update);

routerColours.delete('/colours/:colourId', validateColourId, coloursController.delete);
